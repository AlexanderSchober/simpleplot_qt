...
class Ui_preference_window(object):
    def setupUi(self, preference_window):
        ...
        preference_window.resize(641, 655)
        ...
        self.widget1.setMinimumSize(QtCore.QSize(50, 0))
        ...
        self.plot_tree_view = QtWidgets.QTreeView(self.widget1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.add_plot = QtWidgets.QPushButton(self.widget1)
        self.add_plot.setObjectName("add_plot")
        self.horizontalLayout_3.addWidget(self.add_plot)
        self.remove_plot = QtWidgets.QPushButton(self.widget1)
        self.remove_plot.setObjectName("remove_plot")
        self.horizontalLayout_3.addWidget(self.remove_plot)
        self.verticalLayout_7.addLayout(self.horizontalLayout_3)
        self.verticalLayout_4.addLayout(self.verticalLayout_7)
        self.plot_data_view = QtWidgets.QTableView(self.splitter)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.plot_data_view.sizePolicy().hasHeightForWidth())
        self.plot_data_view.setSizePolicy(sizePolicy)
