...
class BarWidget(Ui_BarWidget):
    ...
    def _connect(self):
        ...
        self.min_spin.valueChanged.connect(self._updatePlot)
        self.width_x_spin.valueChanged.connect(self._updatePlot)
        self.width_y_spin.valueChanged.connect(self._updatePlot)
    ...
    def _disconnect(self):
        ...
        self.min_spin.valueChanged.disconnect(self._updatePlot)
        self.width_x_spin.valueChanged.disconnect(self._updatePlot)
        self.width_y_spin.valueChanged.disconnect(self._updatePlot)
    ...
    def _setInputFields(self):
        ...
        self.min_spin.setValue(self._current_item.parameters['Lower'][0][0])
        self.width_x_spin.setValue(self._current_item.parameters['Width'][0][0])
        self.width_y_spin.setValue(self._current_item.parameters['Width'][0][1])
    ...
    def _updatePlot(self):
        ...
        '''
        self._current_item.parameters['Lower'][0][0]    = self.min_spin.value()
        self._current_item.parameters['Width'][0]       = [self.width_x_spin.value(), self.width_y_spin.value()]
