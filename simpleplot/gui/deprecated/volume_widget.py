...
class VolumeWidget(Ui_VolumeWidget):
    ...
    def _connect(self):
        ...
        '''
        self.gradient_widget.sigGradientChanged.connect(self._updateVolumeColor)
        ...
        self.volume_check.stateChanged.connect(self._updatePlot)
        self.iso_check.stateChanged.connect(self._updatePlot)
        self.iso_levels.valueChanged.connect(self._updateIso)
        ...
        self.iso_color.clicked.connect(self._setSurfaceColor)
    ...
    def _disconnect(self):
        ...
        Connect the methods to the item values
        '''
        self.gradient_widget.sigGradientChanged.disconnect(self._updateVolumeColor)
        ...
        self.volume_check.stateChanged.disconnect(self._updatePlot)
        self.iso_check.stateChanged.disconnect(self._updatePlot)
        self.iso_levels.valueChanged.disconnect(self._updateIso)
        ...
        self.iso_color.clicked.disconnect(self._setSurfaceColor)
    ...
    def _setInputFields(self):
        ...
        self.volume_check.setChecked(self._current_item.parameters['Volume'][0][0])
        self.iso_check.setChecked(self._current_item.parameters['Iso surface'][0][0])
        self.iso_levels.setValue(self._current_item.parameters['Iso value'][0][0])
    ...
    def _setColorButtons(self):
        ...
        self.iso_line_color  = self._current_item.parameters['Iso color'][0][0]
    ...
    def _grabColorPicker(self, widget, name):
        ...
        self.color_picker.connectMethod(self._updateIsoColors)

    def _updateIso(self):
        '''
        Update the isosurface value
        '''
        self._current_item.parameters['Iso value'][0][0]         = self.iso_levels.value()
        self._current_item.updateIsoSurface()
    ...
    def _updatePlot(self):
        ...
        '''
        self._current_item.parameters['Volume'][0][0]            = self.volume_check.isChecked()
        self._current_item.parameters['Iso surface'][0][0]       = self.iso_check.isChecked()

        self._current_item.setData()

    def _updateIsoColors(self, color):
        '''
        Tell the plot item to update the colors
        of the surface plot item
        '''
        ...
        self._current_item.parameters['Iso color'][0][0] = color
        self._current_item.updateIsoColor()

    def _updateVolumeColor(self, color = None):
        '''
        Tell the plot item to update the colors
        of the surface plot item
        '''
        ...
        self._current_item.parameters['Colors'][0]   = colors
        self._current_item.parameters['Positions'][0] = positions
        self._current_item.updateVolumeColor()
