...
from .plot_ray_handlers.ray_distribution import DistributionRayHandler
from .plot_items.SimpleItemSample  import SimpleItemSample

class DistributionPlotHandler(PlotHandler):
    ...
    def __init__(self, **kwargs):
        ...
        self._ray_handler   = DistributionRayHandler()
