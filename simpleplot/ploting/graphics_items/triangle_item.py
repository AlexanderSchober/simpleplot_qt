...
from ..views.triangle_view import TriangleView
from ..views_3D.triangle_view_3D import TriangleView3D

class TriangleItem(GraphicsItem):
    '''
    This is a derivative of the GrahicsItem class
    that will handle the drawing of a Trianle either
    ...
    def setVisual(self):
        ...
        parameters['positions'] = self['Position']
    ...
    def drawGL(self, target_view = None):
        ...
        if self['Visible']:
            self.draw_items = [TriangleView3D()]
            self.default_target.addItem(self.draw_items[0])
            self.setOpenGLMode()
            self.setVisual()
