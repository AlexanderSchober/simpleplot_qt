...
class GraphicsView3D(QtCore.QObject):
    ...
    def _createProgram(self, name:str, vert_shader:str = None, frag_shader:str = None,geometry_shader:str = None, tess_control_shader:str = None, tess_evaluation_shader:str = None, varyings:tuple = ()):
        '''
    ...
    def _createVAO(self, name:str, attr_lists:dict):
        ...
        if not name in self._programs.keys():
            print("Programm not found for creating the vao")
            return
    ...
    def setMVP(self, projection_mat:Matrix44 = Matrix44(), view_mat:Matrix44 = Matrix44(), center_pos:Vector3 = Vector3(), view_pos:Vector3 = Vector3())->None:
        '''
