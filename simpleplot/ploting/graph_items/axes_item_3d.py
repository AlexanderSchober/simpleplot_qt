...
class AxesItem3D(GraphicsItem):
    ...
    def setParameters(self, i: int) -> None:
        ...
        parameters = {'draw_axis': handler['Visible'][0],
                      ...
                      'axis_length': np.array(handler['Axis range'][1:]),
                      'axis_width': np.array([handler['Axis visual'][1]]),
                      'axis_color': np.array(handler['Axis visual'][0].getRgbF()),
                      'axis_center': np.array(handler['Axis position']),
                      'axis_arrow_width': np.array([handler['Axis visual'][2]]),
                      'axis_arrow_length': np.array([handler['Axis visual'][3]]),
                      ...
                      'tick_direction': np.array(handler['Tick direction'])}
