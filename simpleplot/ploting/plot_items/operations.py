...
def getDistance(point_0, point_1):
    '''
    ##############################################
...
def getAngle(point_0, point_1, point_2, degrees = True):
    '''
    ##############################################
    ...
    d_0 = getDistance(point_0, point_1)
    d_1 = getDistance(point_0, point_2)
    ...
    if d_0 == 0 or d_1 ==0 :
        ...
        angle_cos = (
            np.dot(
                vec_0 / getDistance(point_0, point_1),
                vec_1 / getDistance(point_0, point_2)))
...
def angleAroundAxis(points):
    ...
    ##############################################
    #get the angle
    resulting_angle = getAngle(point_0, point_0 + vec_0, point_0 + vec_1)
