...
class LegendView(GraphicsView3D):
    ...
    def setLegend(self, icons:List[np.array], titles:List[str])->None:
        '''
        ...
        icons = [np.zeros((10, 10, 4), dtype=np.uint16) for i in range(len(titles))]
        # titles = [('This is an item %s'%i) for i in range(10)]
