...
from OpenGL.GL import glUseProgram, glGetUniformLocation, glCreateProgram, glAttachShader, ctypes, glGetAttribLocation, glEnableVertexAttribArray, glBindBuffer, GL_FLOAT, GL_ARRAY_BUFFER, glGenBuffers,glBufferData,GL_DYNAMIC_DRAW, GL_QUAD_STRIP
