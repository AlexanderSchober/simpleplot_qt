...
from ..views.ellipse_view import EllipseView
from ..views_3D.ellipse_view_3D import EllipseView3D

class EllipseItem(GraphicsItem):
    '''
    This is a derivative of the GrahicsItem class
    that will handle the drawing of a Ellipse either
    ...
    def setVisual(self):
        ...
        parameters['positions'] = [0,0,0]
        parameters['diameters'] = self['Diameters']
        ...
        self.draw_items[0].setData(**parameters)
