...
class Lorenzian:
    ...
    def Function(self,Parameters):
        ...
        Assymetry   = Parameters[4]
    
    
        #process the function
        HWHM        = ((2*HWHM_0)/(1+numpy.exp(Assymetry*(numpy.array(x)-Position))) )
        
        y           = (Amplitude*(HWHM**2)/((((numpy.array(x)-Position))**2)+HWHM**2))
